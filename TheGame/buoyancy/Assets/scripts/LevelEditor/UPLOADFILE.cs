...
public class UPLOADFILE : MonoBehaviour {
	 ...
	 IEnumerator UploadLevel()  
    {
        ...
        if(!PlayerPrefs.HasKey("val") || PlayerPrefs.GetInt("val") == 0){
            WWW lol = new WWW("http://buoyancy.000webhostapp.com/Accounts/"+PlayerPrefs.GetString("email")+"/infos.txt",form);
            yield return lol;
            if (lol.error != null)
            {
                print("error");
                ...
                string[] lols = lol.text.Split('\n');
                PlayerPrefs.SetInt("val",int.Parse(lols[0]));
            }
            
        }
        if( PlayerPrefs.GetInt("val") == 1){
            StreamReader sr;
            if(save.tempoPlay){
            ...
            else
            {
                ...
                if(w.uploadProgress == 1 && w.isDone)
                {
                    ...
                    WWW w2 = new WWW("http://buoyancy.000webhostapp.com/Accounts/"+ PlayerPrefs.GetString("email") + "/"+ fileName+".txt");
            ...
            print("your account is not validated... check your email");
        }
